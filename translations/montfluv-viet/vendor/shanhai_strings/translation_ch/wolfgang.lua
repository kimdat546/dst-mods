...
-- 鲲鹏BOSS
________DESCRIBE.KUNPENG = "超超超级海洋霸主"
...
________DESCRIBE.TORTOISE_CUSTARD = {
    GENERIC = "它会让沃尔夫冈的肌肉更大！",
}
-- 悬河池塘
________DESCRIBE.XUANHE_POND = {
    STAGE_1 = "干涸的池塘，也许我们可以帮它做点什么",
    STAGE_2 = "它需要古老的天地灵韵",
    STAGE_3 = "嗯，它说什么，金黄满树如蝶翩？",
    STAGE_4 = "啊，这次是什么，不见风霜刻骨痕？",
    STAGE_5 = "很高兴我能帮上忙",
}
-- 合璧蓝图雕塑
