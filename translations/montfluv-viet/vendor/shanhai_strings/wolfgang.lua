...
________DESCRIBE.DEEPSEACAVE_SEAL = {
    GENERIC = "Has incomprehensible markings",
}
-- Tower Wall
________DESCRIBE.DEEPSEACAVE_WALL = {
    GENERIC = "Might actually be harder than Wolfgang's fists...",
}
-- Cloud Saddle
...
________DESCRIBE.SHANHAI_SHELLCHEST = {
    GENERIC = "Wolfgang can smash it open!",
}
...
________DESCRIBE.SHANHAI_FLOWERVINE = {
    GENERIC = "Too weak, Wolfgang is the strongest!",
}
-- Blue Butterfly
...
________DESCRIBE.SHANHAI_SECRETPLACE = {
    GENERIC = "Hard, but not as hard as Wolfgang's fist!",
}
-- Ginseng Spirit
...
________DESCRIBE.SHANHAIVINE_GEM = {
    GENERIC = "Wolfgang can smash it with one punch",
}
-- Nightberry Vine
...
________DESCRIBE.SHANHAIVINE_MOON = {
    GENERIC = "Vine with beautiful flowers",
}
-- Festival Evergreen
...
________DESCRIBE.SHANHAI_XIRANG_ITEM = {
    GENERIC = "It seems to keep growing",
...
________DESCRIBE.SHANHAI_ZHUYAN = {
    GUARD = "Its fists are as hard as Wolfgang's!",
    NORMAL = "Unguarded—perfect chance!",
}
-- Phoenix Summoning
________DESCRIBE.STATUE_CHAOFENG = {
    GENERIC = "Faded statue, maybe recolor it",
    ALL_FOUND = "A magnificent bird",
}
-- Moon Devourer
________DESCRIBE.STATUE_EATMOON = {
    EYESCLOSE = "Perhaps needs eyes",
    EYESOPEN = "It opened its eyes!",
    MOONEATEN = "What's in its mouth? The moon?",
    NODOG = "Oh, where'd it go?",
}
-- Nirvana Rebirth
...
________DESCRIBE.TORTOISE_CUSTARD = {
    GENERIC = "It'll make Wolfgang's muscles bigger!",
}
-- Xuanhe Pond
...
________DESCRIBE.SH_FIREWORKS = {
    GENERIC = "Wolfgang can punch it away",
}
-- Ginkgo Leaf
________DESCRIBE.SHANHAI_GINKGOLEAVE = {
    GENERIC = "This fan is too small",
}
-- Trapped Kunpeng
...
________DESCRIBE.DSC_EGGVINE = {
    GENERIC = "Quality protein source",
}
-- Tallbird Egg Seed
