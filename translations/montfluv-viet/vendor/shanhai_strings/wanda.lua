...
________DESCRIBE.DEEPSEACAVE_EXIT = {
    NO_ACCESS = "An inescapable space",
...
________DESCRIBE.SHANHAI_GINKGO_TREE = {
    SHORT_STUMP = "We should feel remorse",
    SHORT = "Scarcely any leaves",
...
________DESCRIBE.DEEPSEACAVE = {
    IDLE = "A magical microcosm within",
    IDLE_DEPLOY = "Bigger on the inside",
...
________DESCRIBE.DEEPSEACAVE_POOL = {
    GENERIC = "I'll fix my watch before falling in!",
}
-- Tower Seal
________DESCRIBE.DEEPSEACAVE_SEAL = {
    GENERIC = "Artifact from distant timelines",
}
-- Tower Wall
________DESCRIBE.DEEPSEACAVE_WALL = {
    GENERIC = "Should find ways to reinforce it",
}
-- Cloud Saddle
...
________DESCRIBE.SHANHAI_HIDDENCELLAR = {
    GENERIC = "Gift for explorers",
}
-- Stone Cellar
________DESCRIBE.SHANHAI_HIDDENCELLAR_USE = {
    GENERIC = "This storage withstands time's test",
}
-- Flower Vine
________DESCRIBE.SHANHAI_FLOWERVINE = {
    GENERIC = "Too thin for swinging",
}
-- Blue Butterfly
...
________DESCRIBE.SHANHAI_GOUMANG_PLANT = {
    IDLE = "Perhaps seen in distant timelines",
    NORMAL = "Time will tell",
    DEAD = "May need special nutrients",
    GENERIC = "What's happening?",
}
-- Goumang Mark
________DESCRIBE.SHANHAI_GOUMANG = {
    GENERIC = "Gleaming through time's river",
}
-- Hidden Exit
...
________DESCRIBE.SHANHAI_GINKGO = {
    GENERIC = "Who smells something foul?",
}
-- Ginkgo Sapling
...
________DESCRIBE.SHANHAI_REDROPE = {
    GENERIC = "Woven through time's flow",
}
-- Gong
...
________DESCRIBE.SHANHAIVINE_GEM = {
    GENERIC = "Don't want it cracking my skull",
}
-- Nightberry Vine
...
________DESCRIBE.SHANHAI_WINTER_TREE = {
    ...
    CANDECORATE = "Requires bulbs and tinsel",
    YOUNG = "Festival approaches",
}
-- Living Soil
________DESCRIBE.SHANHAI_XIRANG_ITEM = {
    GENERIC = "Self-growing earth mound",
...
________DESCRIBE.SHANHAI_ZHUYAN = {
    GUARD = "Direct confrontation seems unwise",
...
________DESCRIBE.STATUE_EATMOON = {
    EYESCLOSE = "Perhaps needs eyes",
    EYESOPEN = "Why its statue exists?",
    MOONEATEN = "Did it absorb lunar power?",
    NODOG = "Moon's energy feels weaker",
}
-- Nirvana Rebirth
________DESCRIBE.STATUE_NIEPAN = {
    IS_COOLDOWN = "Time erased its fervor",
    IS_HOLDING = "Time will reveal all",
    IS_NOT_HOLDING = "Iron grill feast today?",
}
-- Turtle Egg Custard
________DESCRIBE.TORTOISE_CUSTARD = {
    GENERIC = "Is... this edible?",
}
-- Xuanhe Pond
...
________DESCRIBE.SH_SEASONAQUARIUM = {
    SPRING = "Spring mountains, lonely bird songs",
...
________DESCRIBE.SH_SPARKLER_3 = {
    GENERIC = "Beauty amidst survival",
}
-- Zhuyan Horn
