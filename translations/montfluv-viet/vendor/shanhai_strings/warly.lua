...
________DESCRIBE.SHANHAI_GANODERMA = {
    PICKED = "Now the little mushrooms won't be so cocky",
...
________DESCRIBE.DEEPSEACAVE_POOL = {
    GENERIC = "Hope we can raise fish here!",
}
-- Tower Seal
________DESCRIBE.DEEPSEACAVE_SEAL = {
    GENERIC = "Unreadable script!",
}
-- Tower Wall
...
________DESCRIBE.SHANHAI_GOUMANG_ITEM = {
    GENERIC = "Fragrant, could be ingredient",
}
-- Goumang Plant
...
________DESCRIBE.SHANHAI_GOUMANG = {
    GENERIC = "Contains wood elemental essence",
}
-- Hidden Exit
...
________DESCRIBE.SHANHAI_MUSHROOMGUARD = {
    GENERIC = "It won't grow bigger, I'm sure!",
}
-- Picked Ganoderma
________DESCRIBE.GANODERMA_CAP = {
    GENERIC = "Mushroom ingredient",
}
-- Cooked Ganoderma
...
________DESCRIBE.SHANHAI_COOKEDSHANSHEN = {
    GENERIC = "Culinary essence after cooking",
}
-- Small Statue
...
________DESCRIBE.SHANHAIVINE_GEM = {
    GENERIC = "Hope there's food inside the stone!",
}
-- Nightberry Vine
...
________DESCRIBE.SHANHAI_XIRANG_ITEM = {
    GENERIC = "Great tool for food gathering",
...
________DESCRIBE.SHANHAI_ZHUYAN = {
    GUARD = "Would it like bananas?",
    NORMAL = "Unguarded—perfect chance!",
}
-- Phoenix Summoning
________DESCRIBE.STATUE_CHAOFENG = {
    GENERIC = "Faded statue—maybe recolor?",
    ALL_FOUND = "Majestic statue",
}
-- Moon Devourer
________DESCRIBE.STATUE_EATMOON = {
    EYESCLOSE = "Perhaps needs eyes",
    EYESOPEN = "It opened its eyes!",
    MOONEATEN = "The moon was devoured...",
    NODOG = "Where did it go?",
}
-- Nirvana Rebirth
...
________DESCRIBE.TORTOISE_CUSTARD = {
    GENERIC = "Technically not a proper dish!",
}
-- Xuanhe Pond
...
________DESCRIBE.SH_SPARKLER_3 = {
    GENERIC = "Stunning—maybe she'd like it too...",
}
-- Zhuyan Horn
...
________DESCRIBE.SH_FIREWORKS = {
    GENERIC = "Produces beautiful fireworks...",
}
-- Ginkgo Leaf
________DESCRIBE.SHANHAI_GINKGOLEAVE = {
    GENERIC = "What plant is this?",
}
-- Trapped Kunpeng
...
________DESCRIBE.SH_FLOWER = {
    GENERIC = "I used to bring one home daily...",
}
-- Ornamental Rock
________DESCRIBE.SH_ROCK_1 = {
    GENERIC = "Kinda rough on feet",
}
...
________DESCRIBE.DSC_EGGVINE = {
    GENERIC = "Oh, perfect food source!",
}
-- Tallbird Egg Seed
