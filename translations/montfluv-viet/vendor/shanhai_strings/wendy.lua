...
________DESCRIBE.SHANHAI_GINKGO = {
    GENERIC = "Ending breeds new life",
}
-- Ginkgo Sapling
...
________DESCRIBE.SHANHAI_REDROPE = {
    GENERIC = "Something brimming with vitality",
}
-- Gong
...
________DESCRIBE.SHANHAI_ZHUYAN = {
    GUARD = "Look Abigail, what's that?",
...
________DESCRIBE.STATUE_EATMOON = {
    ...
    EYESOPEN = "Still devoid of life",
    MOONEATEN = "Bright. Yet silent",
    NODOG = "It heralds the moon's demise",
}
-- Nirvana Rebirth
________DESCRIBE.STATUE_NIEPAN = {
    IS_COOLDOWN = "It has fallen silent",
    IS_HOLDING = "Even flames extinguish",
    IS_NOT_HOLDING = "Vibrant vitality",
}
-- Turtle Egg Custard
...
________DESCRIBE.SH_SPARKLER_SMALL = {
    GENERIC = "Abigail, do you like it?",
}
-- Small Firework
