...
________DESCRIBE.SHANHAI_GINKGO_TREE = {
    ...
    TALL_YELLOW = "Yellow and beautiful!",
...
________DESCRIBE.GANODERMA_CAP = {
    GENERIC = "Another mushroom",
}
-- Cooked Ganoderma
________DESCRIBE.GANODERMA_CAP_COOKED = {
    GENERIC = "Looks unappetizing!",
}
...
________DESCRIBE.SHANHAIVINE_GEM = {
    GENERIC = "Good thing I have a helmet",
}
-- Nightberry Vine
...
________DESCRIBE.STATUE_EATMOON = {
    ...
    EYESOPEN = "A majestic wolf statue!",
    MOONEATEN = "Wait—what's in its mouth?",
    NODOG = "The statue vanished!",
}
-- Nirvana Rebirth
________DESCRIBE.STATUE_NIEPAN = {
    IS_COOLDOWN = "No longer fiery",
...
________DESCRIBE.DSC_EGGVINE = {
    GENERIC = "Daily eggs for everyone!",
}
-- Tallbird Egg Seed
