...
if command -v luajit >/dev/null; then CHECK="luajit -bl"; else CHECK="luac -p"; echo "  ⚠ không có luajit, dùng luac (5.5) — không bắt được khác biệt 5.1"; fi

echo "▸ Kiểm tra cú pháp Lua ($CHECK)…"
n=0
